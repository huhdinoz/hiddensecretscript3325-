...
local tar = "pwthon" -- Replace with the actual player's name
local accounts = {7143689916, 7143686870, 7143685171, 7143680018, 7143632938}
local host = 408657721 -- Replace with the actual host's UserID
local ROBLOSECURITY = ""
local maxFollowDistance = 20 -- Maximum distance before teleporting to the target
local enableWebhookLogs = true
local webhookURL = ""
local webhookUsername = "COSMIC"
local enableCommandCorrection = true -- Toggle command correction
local correctionThreshold = 2 -- Maximum Levenshtein distance to correct a command
local enableOffset = true -- Toggle offset for walkto and tpto commands
